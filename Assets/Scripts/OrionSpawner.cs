...
public class OrionSpawner : MonoBehaviour
{
    ...
    void SpawnStars(){
        for (int i = 0; i < starPositions.Count; i++)
        {
            ...
            // float brightnessFactor = starMagnitudes[i]/2;
    ...
    void LoadStarDataFromCSV(){
        ...
        string filePath = Application.dataPath + "/Orion.csv";
        ...
        foreach (string line in dataLines.Skip(1).ToArray())
        {
            ...
            Vector3 coordinates = calculateCoordinates(ra, dec, parallax*5000);
